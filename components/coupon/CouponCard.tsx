  ...
  return (
    <div class="relative max-w-md block overflow-hidden">
      <div class="relative flex flex-col justify-center items-center w-full bg-gradient-to-r from-green-500 from-80% to-green-600 rounded-xl p-10 gap-y-4">
        <span class="absolute top-1/2 -translate-y-1/2 -left-4 my-auto w-8 h-8 bg-white rounded-full"></span>
        <span class="absolute top-1/2 -translate-y-1/2 -right-4 my-auto w-8 h-8 bg-white rounded-full"></span>
        <div>
        ...
        <div class="flex">
          <p class="border border-dashed px-4 py-2 rounded-s-md text-white font-black">{code}</p>
          <button 
            onClick={() => {
